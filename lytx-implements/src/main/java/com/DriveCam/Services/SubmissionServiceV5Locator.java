...
public class SubmissionServiceV5Locator extends org.apache.axis.client.Service implements com.DriveCam.Services.SubmissionServiceV5 {
    ...
    public SubmissionServiceV5Locator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public com.DriveCam.Contracts.ISubmissionServiceV5 getBasicHttpBinding_ISubmissionServiceV5() throws javax.xml.rpc.ServiceException {
    ...
    public com.DriveCam.Contracts.ISubmissionServiceV5 getBasicHttpBinding_ISubmissionServiceV5(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.DriveCam.Services.BasicHttpBinding_ISubmissionServiceV5Stub _stub = new com.DriveCam.Services.BasicHttpBinding_ISubmissionServiceV5Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.DriveCam.Contracts.ISubmissionServiceV5.class.isAssignableFrom(serviceEndpointInterface)) {
                com.DriveCam.Services.BasicHttpBinding_ISubmissionServiceV5Stub _stub = new com.DriveCam.Services.BasicHttpBinding_ISubmissionServiceV5Stub(new java.net.URL(BasicHttpBinding_ISubmissionServiceV5_address), this);
                _stub.setPortName(getBasicHttpBinding_ISubmissionServiceV5WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DriveCam.com/Services", "BasicHttpBinding_ISubmissionServiceV5"));
        }
