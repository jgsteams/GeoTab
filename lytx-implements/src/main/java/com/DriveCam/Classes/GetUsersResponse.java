...
public class GetUsersResponse  implements java.io.Serializable {
    ...
    private com.DriveCam.Classes.UserInfo[] users;
    ...
    public GetUsersResponse(
           ...
           com.DriveCam.Classes.UserInfo[] users) {
           this.error = error;
    ...
    /**
     * Gets the error value for this GetUsersResponse.
     * 
     * @return error
     */
    ...
    /**
     * Sets the error value for this GetUsersResponse.
     * 
     * @param error
     */
    ...
    /**
     * Gets the message value for this GetUsersResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this GetUsersResponse.
     * 
     * @param message
     */
     ...
     * @return users
     */
    public com.DriveCam.Classes.UserInfo[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.DriveCam.Classes.UserInfo[] users) {
        this.users = users;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://DriveCam.com/Classes", "GetUsersResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://DriveCam.com/Classes", "Users"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://DriveCam.com/Classes", "UserInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://DriveCam.com/Classes", "UserInfo"));
        typeDesc.addFieldDesc(elemField);
    }
