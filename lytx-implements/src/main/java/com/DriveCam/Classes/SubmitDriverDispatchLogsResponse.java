...
public class SubmitDriverDispatchLogsResponse  implements java.io.Serializable {
    ...
    public SubmitDriverDispatchLogsResponse(
           ...
           java.lang.String validationResponse) {
           this.error = error;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmitDriverDispatchLogsResponse)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmitDriverDispatchLogsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://DriveCam.com/Classes", "SubmitDriverDispatchLogsResponse"));
