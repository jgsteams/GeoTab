...
public class EventsInfo  implements java.io.Serializable {
     ...
     * @param behaviors
     */
    public void setBehaviors(org.datacontract.schemas._2004._07.DriveCam_HindSight_Messaging_Messages_MessageClasses_Api.EventBehavior[] behaviors) {
        this.behaviors = behaviors;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EventsInfo)) return false;
        ...
        _equals = true && 
            ((this.behaviors==null && other.getBehaviors()==null) || 
             (this.behaviors!=null &&
              java.util.Arrays.equals(this.behaviors, other.getBehaviors()))) &&
            ((this.coachId==null && other.getCoachId()==null) || 
             (this.coachId!=null &&
              this.coachId.equals(other.getCoachId()))) &&
            ((this.creationDate==null && other.getCreationDate()==null) || 
             (this.creationDate!=null &&
              this.creationDate.equals(other.getCreationDate()))) &&
            ((this.customerEventId==null && other.getCustomerEventId()==null) || 
             (this.customerEventId!=null &&
              this.customerEventId.equals(other.getCustomerEventId()))) &&
            ...
            ((this.downloadedDate==null && other.getDownloadedDate()==null) || 
             (this.downloadedDate!=null &&
              this.downloadedDate.equals(other.getDownloadedDate()))) &&
            ...
            ((this.ERSerialNumber==null && other.getERSerialNumber()==null) || 
             (this.ERSerialNumber!=null &&
              this.ERSerialNumber.equals(other.getERSerialNumber()))) &&
            ...
            ((this.forwardMax==null && other.getForwardMax()==null) || 
             (this.forwardMax!=null &&
              this.forwardMax.equals(other.getForwardMax()))) &&
            ((this.forwardThreshold==null && other.getForwardThreshold()==null) || 
             (this.forwardThreshold!=null &&
              this.forwardThreshold.equals(other.getForwardThreshold()))) &&
            ...
            ((this.lateralMax==null && other.getLateralMax()==null) || 
             (this.lateralMax!=null &&
              this.lateralMax.equals(other.getLateralMax()))) &&
            ((this.lateralThreshold==null && other.getLateralThreshold()==null) || 
             (this.lateralThreshold!=null &&
              this.lateralThreshold.equals(other.getLateralThreshold()))) &&
            ...
            ((this.recordDateTZ==null && other.getRecordDateTZ()==null) || 
             (this.recordDateTZ!=null &&
              this.recordDateTZ.equals(other.getRecordDateTZ()))) &&
            ((this.recordDateUTC==null && other.getRecordDateUTC()==null) || 
             (this.recordDateUTC!=null &&
              this.recordDateUTC.equals(other.getRecordDateUTC()))) &&
            ...
            ((this.reviewedDate==null && other.getReviewedDate()==null) || 
             (this.reviewedDate!=null &&
              this.reviewedDate.equals(other.getReviewedDate()))) &&
            ...
            ((this.shockThreshold==null && other.getShockThreshold()==null) || 
             (this.shockThreshold!=null &&
              this.shockThreshold.equals(other.getShockThreshold()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getBehaviors() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBehaviors());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EventsInfo.class, true);
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/DriveCam.HindSight.Messaging.Messages.MessageClasses.Api", "EventBehavior"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/DriveCam.HindSight.Messaging.Messages.MessageClasses.Api", "EventBehavior"));
