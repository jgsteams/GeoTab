...
public class GetGroupsResponse  implements java.io.Serializable {
    ...
    private com.DriveCam.Classes.GroupInfo[] groups;
    ...
    public GetGroupsResponse(
           ...
           com.DriveCam.Classes.GroupInfo[] groups,
     ...
     * @return groups
     */
    public com.DriveCam.Classes.GroupInfo[] getGroups() {
        return groups;
    }
     ...
     * @param groups
     */
    public void setGroups(com.DriveCam.Classes.GroupInfo[] groups) {
        this.groups = groups;
    }
