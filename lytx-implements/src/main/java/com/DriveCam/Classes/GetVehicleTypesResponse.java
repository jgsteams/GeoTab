...
public class GetVehicleTypesResponse  implements java.io.Serializable {
    ...
    private com.DriveCam.Classes.VehicleType[] vehicleTypes;
    ...
    public GetVehicleTypesResponse(
           ...
           com.DriveCam.Classes.VehicleType[] vehicleTypes) {
           this.error = error;
     ...
     * @return vehicleTypes
     */
    public com.DriveCam.Classes.VehicleType[] getVehicleTypes() {
        return vehicleTypes;
    }
     ...
     * @param vehicleTypes
     */
    public void setVehicleTypes(com.DriveCam.Classes.VehicleType[] vehicleTypes) {
        this.vehicleTypes = vehicleTypes;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetVehicleTypesResponse)) return false;
        ...
        _equals = true && 
            ...
            ((this.vehicleTypes==null && other.getVehicleTypes()==null) || 
    ...
    public synchronized int hashCode() {
        ...
        if (getVehicleTypes() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getVehicleTypes());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetVehicleTypesResponse.class, true);
