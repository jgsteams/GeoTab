...
public class GetEventStatusesResponse  implements java.io.Serializable {
    ...
    private com.DriveCam.Classes.EventStatus[] eventStatuses;
    ...
    public GetEventStatusesResponse(
           ...
           com.DriveCam.Classes.EventStatus[] eventStatuses,
     ...
     */
    public com.DriveCam.Classes.EventStatus[] getEventStatuses() {
        return eventStatuses;
    }
     ...
     * @param eventStatuses
     */
    public void setEventStatuses(com.DriveCam.Classes.EventStatus[] eventStatuses) {
        this.eventStatuses = eventStatuses;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetEventStatusesResponse)) return false;
        ...
        _equals = true && 
            ...
            ((this.eventStatuses==null && other.getEventStatuses()==null) || 
    ...
    public synchronized int hashCode() {
        ...
        if (getEventStatuses() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getEventStatuses());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetEventStatusesResponse.class, true);
